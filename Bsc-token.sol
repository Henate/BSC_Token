...
contract Blocktechnology is ERC20, Ownable {
        ...
        onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "Cannot delete pancake exchange pairs from automatedmarketmakerpairs"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "Auto market maker pairing is set to this value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            ...
            "Gas treatment must be between 200000 and 500000"
        );
        require(
            newValue != gasForProcessing,
            "Cannot update gasforprocessing to the same value"
        );
